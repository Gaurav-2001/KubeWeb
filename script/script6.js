...
function fun1(){
    ...
    xhr.open("POST","http://192.168.43.243/cgi-bin/main.py?cmd=" + "sudo kubectl get all", false);
    xhr.send();
...
function fun2(){
    ...
    var l = k.value;
    var xhr= new XMLHttpRequest();
    xhr.open("POST","http://192.168.43.243/cgi-bin/main.py?cmd=" + "sudo kubectl delete " + i + "/" + j + " -n " + l, false);
    xhr.send();
    var output = xhr.responseText;
    var outputbox = document.getElementById("output");
    outputbox.style.color = "green";
